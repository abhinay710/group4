    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 v-if="editedDiningHall.id === undefined" class="modal-title" id="diningHallEditModalLabel">Add Dining Hall
          </h5>
          <h5 v-if="editedDiningHall.id !== undefined" class="modal-title" id="diningHallEditModalLabel">Edit Dining Hall
          </h5>
        ...
        <div class="modal-body">
          <form @submit.prevent="saveChanges">
            ...
            <div class="form-group">
              ...
              <input type="text" v-model="editedDiningHall.diningHallName" class="form-control" id="editDiningHallName"
                required>
            </div>
...
export default {
  ...
  methods: {
    ...
    async saveChanges() {
      try {
        this.editedDiningHall.updatedBy = localStorage.getItem('name');
        this.editedDiningHall.updatedOn = new Date();
